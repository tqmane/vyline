...
- [x] Apple icon sources use the complete SF Symbols 8 all-weights export, copying regular source bytes unchanged and recording source path/hash. Legacy symbol names are mapped only to observed current canonical families.
